...
module.exports = function(RED) {
    ...
    function AdjacentNode(n) {
        ...
        this.on('input', function (msg) {
            node.warn("Above saw a payload: " + msg.payload);
            
         //var query = "MATCH (n:`Button`) RETURN n LIMIT 25";

         	//var query = 'MATCH (a:Apartment) WHERE a.name = "B3.4" RETURN a'
            var query = 'MATCH (a:Apartment {name:"'+ msg.payload +'"})-[:`BELOW`*]->(b)<-[:LIVES_IN]-(u:User) WHERE NOT b.name="' + msg.payload + '" RETURN DISTINCT u,b';
    ...
    // Node functions.
    RED.nodes.registerType("above",AdjacentNode);
